...
const sections: ArticleSection[] = [
  {
    ...
    paragraphs: [
      ...
      "Lag is the gap between the live event and what you are seeing. A 30-second lag on a goal kick is normal for some streaming pipelines and impossible to remove without changing the stream technology. Low-latency IPTV, where lag is kept to a few seconds rather than tens of seconds, is the genuine \"live\" experience.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Cause four is the server side — the IPTV provider's own infrastructure. If the source feed is overloaded, no amount of local tuning will fix it. This is where transparent providers matter — look for ones that publish a clear uptime policy and respond quickly when outages do occur.",
